...
import com.handmark.pulltorefresh.library.internal.FlipLoadingLayoutFooter;
import com.handmark.pulltorefresh.library.internal.LoadingLayout;
import com.handmark.pulltorefresh.library.internal.RotateLoadingLayout;
import com.handmark.pulltorefresh.library.internal.RotateLoadingLayoutFooter;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    public final void onRefreshComplete() {
        if (isRefreshing() || mState == State.RESET) {
    ...
    /**
     * @return Either
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.Orientation#VERTICAL}
     * or
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.Orientation#HORIZONTAL}
     ...
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#PULL_TO_REFRESH}
     * state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#REFRESHING}
     * or
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#MANUAL_REFRESHING}
     * state.
     *
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#RESET}
     * state.
     */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mFooterLayout = createLoadingLayoutFooter(context, Mode.PULL_FROM_END,
                a);
    ...
    public static enum Mode {
         ...
         * {@link com.handmark.pulltorefresh.library.PullToRefreshBase#setRefreshing()
         * setRefreshing()}.
         */
...
// ===========================================================
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         *                    or
         *                    {@link com.handmark.pulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_END}
