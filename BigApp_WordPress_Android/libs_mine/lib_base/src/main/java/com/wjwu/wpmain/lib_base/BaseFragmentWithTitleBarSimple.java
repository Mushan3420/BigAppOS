 ...
 * @author AG
 */
public abstract class BaseFragmentWithTitleBarSimple extends BaseInitFragment implements
        OnClickListener {
    ...
    private View mRl_title_bar, v_line_below_titlebar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.z_fragment_with_title_bar_simple,
                container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRl_title_bar = view.findViewById(R.id.layout_title_bar);
        v_line_below_titlebar = view.findViewById(R.id.v_line_below_titlebar);
        mTv_title = (TextView) mRl_title_bar.findViewById(R.id.tv_title);
        mIv_left = (ImageView) mRl_title_bar.findViewById(R.id.iv_left);
        mIv_right = (ImageView) mRl_title_bar.findViewById(R.id.iv_right);
        mProgressBar = (ProgressBar) mRl_title_bar.findViewById(R.id.progressBar);
    ...
    public void setTitleBarVisible(boolean visible) {
        if (mRl_title_bar != null) {
            if (visible) {
                mRl_title_bar.setVisibility(View.VISIBLE);
            } else {
                v_line_below_titlebar.setVisibility(View.GONE);
                mRl_title_bar.setVisibility(View.GONE);
            }
        }
    }
