...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context) {
		super(context);
		initColors(0xFF7DC62D, 0xFF9D9D9D, STYLE_FILL, STYLE_STROKE);
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mImageSwitcher != null) {
			count = mImageSwitcher.getViewCount();
		}
	...
	@Override
	public void setImageSwitcher(ZImageSwitcher view) {
		resetTimer();
		mImageSwitcher = view;
		if (mImageSwitcher.getViewCount() <= 1)
			setVisibility(View.GONE);
		else {
			setVisibility(View.VISIBLE);
		}
