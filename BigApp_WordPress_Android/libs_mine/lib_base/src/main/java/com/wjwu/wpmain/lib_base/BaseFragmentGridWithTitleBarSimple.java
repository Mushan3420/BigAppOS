 ...
 * @author AG
 */
public abstract class BaseFragmentGridWithTitleBarSimple extends BaseFragmentGrid implements
        OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.z_fragment_grid_with_title_bar_simple,
                container, false);
    }
