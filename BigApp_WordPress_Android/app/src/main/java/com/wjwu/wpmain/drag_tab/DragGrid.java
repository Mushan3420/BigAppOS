...
import com.wjwu.wpmain.util.DensityTools;

public class DragGrid extends GridView {
    /***
     * 前面几个不能移动, 0 代表1个，以此类推
     */
    public int maxNotMovePosition = 0;
    /**
     * 点击时候的X位置
     */
    public int downX;
    ...
    public void init(Context context) {
        ...
        //将布局文件中设置的间距dip转为px
        mHorizontalSpacing = DensityTools.dp2px(context, mHorizontalSpacing);
    }
    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                if (startPosition <= maxNotMovePosition) {//TODO
                    return false;
                }
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值
    ...
    public void OnMove(int x, int y) {
        ...
        if (dPosition > maxNotMovePosition) {
