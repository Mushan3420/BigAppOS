...
@property (nonatomic , strong) MovieMyPageControl *pageControl;

@end

@implementation HomeCycleScrollView

- (MovieMyPageControl *)pageControl
{
    ...
    if (self.totalPageCount > 1) {
        if (!_pageControl) {
            ...
            UIImage *normalDotImage = [UIImage imageNamed:@"ico_page_dot"];
            UIImage *highlightDotImage = [UIImage imageNamed:@"ico_page_dot_on"];
            CGFloat pageControlWidth = totalPageCounts * dotGapWidth + (totalPageCounts - 1) * dotGapWidth;
            CGRect pageControlFrame = CGRectMake(CGRectGetMaxX(self.scrollView.frame) - pageControlWidth - 10 ,
                                                 CGRectGetHeight(self.scrollView.frame) -16,
                                                 pageControlWidth,
                                                 dotGapWidth);
            
            _pageControl = [[MovieMyPageControl alloc] initWithFrame:pageControlFrame
