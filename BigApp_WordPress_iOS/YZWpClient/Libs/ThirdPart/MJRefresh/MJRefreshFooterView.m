...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"UP_LOAD_MORE", nil);
        self.releaseToRefreshText = NSLocalizedString(@"RELEASE_LOAD_MORE", nil);
        self.refreshingText = NSLocalizedString(@"LOADING_MORE", nil);
    }
    return self;
}
